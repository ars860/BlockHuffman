...
std::pair<std::string, encode_report> encode(std::string &message, bool generate_report) {
    bit_vector res;
...
std::string encode_report::show() const {
...
std::string encode_report::csv(const std::string &file_name) {
